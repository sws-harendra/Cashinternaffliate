...
@push('title')
    <title>Edit Job Location | {{ env('APP_NAME') }}</title>
@endpush
...
<div class="pcoded-content">
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Edit Job Location</h5>
                        <p class="m-b-0">Update job location details</p>
                    </div>
                </div>
                <div class="col-md-4">
    ...
    <div class="card">
        <div class="card-block">
            ...
            <form method="POST"
                  action="{{ route('admins.job-locations.update', $jobLocation->id) }}">
                @csrf
                @method('PUT')
