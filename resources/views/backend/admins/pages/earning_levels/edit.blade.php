            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admins.earning-levels.index', $level->affiliate_product_id) }}">Earning Levels</a></li>
                    ...
                    <div class="card-block">
                        ...
                        <form method="POST" action="{{ route('admins.earning-levels.update', $level->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="level_description" value="{{ $level->level_description }}" class="form-control" required>
                            </div>

                            <div class="form-group">
                                <label>Amount (₹)</label>
                                <input type="number" step="0.01" name="amount" value="{{ $level->amount }}" class="form-control" required>
                            </div>
