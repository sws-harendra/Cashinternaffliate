...
@push('title')
    <title>Edit Experience Level | {{ env('APP_NAME') }}</title>
@endpush
...
<div class="pcoded-content">
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Edit Experience Level</h5>
                        <p class="m-b-0">Update experience level details</p>
                    </div>
                </div>
                <div class="col-md-4">
    ...
    <div class="card">
        <div class="card-block">
            ...
            <form method="POST"
                  action="{{ route('admins.experience-levels.update', $experienceLevel->id) }}">
                @csrf
                @method('PUT')
