...
@push('title')
    <title>Recruiter Dashboard | {{ env('APP_NAME') }}</title>
@endpush
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="page-header-title">
                            ...
                            <p class="m-b-0">Welcome to {{ env('APP_NAME') }} Recruiter Dashboard</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="card ">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="align-middle m-b-30">
                                            <img src="{{ asset('backend/assets/images/avatar-3.jpg') }}" alt="user image"
                                                class="img-radius img-40 align-top m-r-15">
                                            <div class="d-inline-block">
                                                <h6>David Jones</h6>
                                                <p class="text-muted m-b-0">Developer</p>
